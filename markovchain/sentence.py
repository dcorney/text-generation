...
class Sentence(object):
    ...
    def generate_sentence(self, start, target_length=None):
            """
            ...
            while attempts > 0:
                ...
                while result[0] != utils.START_TOKEN:
                    ...
                    logger.info("Generate reverse from '%s' to '%s':  ", str(result[0:mc_order]), new)
                    result.insert(0, new)
                # Evaluate sentence
    ...
    def polish_sentence(self, sentence):
        ...
        # TODO: if polished[-2] is not a punctuation mark, insert a ".'"
        return polished

    def to_string(self, sentence):
